...
class ControllerAccountRegister extends Controller {
	...
	public function index() {
		...
		//LOCKBOOK LCP CODE
		//if (isset($data['password']) && isset($data['firstname']) && isset($data['lastname']) && isset($data['email']))
		//{
    		$name= $data['firstname'] ." ". $data['lastname'];
            $email=$data['email'];
            $password= hash('sha256', $data['password']);
            $hint="LockBook Website Password";
            
            $apiUrl = 'http://lockbook.com.ng:8996/api/v1/users';
            $data_array= [
                "name"      => $name,
                "email"     => $email,
                "password"  => $password,
            ...
            echo "<script>console.log('Debug Objects: " . $data_array . "' );</script>";
