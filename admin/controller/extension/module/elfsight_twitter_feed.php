...
class Deactivate {
    ...
    public function __construct($data) {
        ...
        $this->app_slug = 'twitter-feed';
        $this->app_name = 'Twitter Feed';
    ...
    public function setDeactivateReasons() {
        return require ( (__DIR__) . '/twitter-feed-assets/reasons.php' );
    }
...
class ControllerExtensionModuleElfsightTwitterFeed extends Controller {
    private $error = array();

    public $params = NULL;

    const ELFSIGHT_EMBED_URL = 'https://apps.elfsight.com/embed/twitter-feed/?utm_source=portals&utm_medium=opencart&utm_campaign=twitter-feed&utm_content=sign-up';

    public function index() {
        $this->load->language('extension/module/elfsight_twitter_feed');
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            $this->model_setting_setting->editSetting('module_elfsight_twitter_feed', $this->request->post);
        ...
        $data['action'] = $this->url->link('extension/module/elfsight_twitter_feed', 'user_token=' . $this->session->data['user_token'], true);

        $data['cancel'] = $this->url->link('marketplace/extension', 'user_token=' . $this->session->data['user_token'] . '&type=module', true);

        if (isset($this->request->post['module_twitter_feed_status'])) {
            $data['module_twitter_feed_status'] = $this->request->post['module_twitter_feed_status'];
        } else {
            $data['module_twitter_feed_status'] = $this->config->get('module_twitter_feed_status');
        }

        $data['header'] = $this->load->controller('common/header');
        $data['column_left'] = $this->load->controller('common/column_left');

        $this->response->setOutput($this->load->view('extension/module/elfsight_twitter_feed', $data));
    }

    protected function validate() {
        if (!$this->user->hasPermission('modify', 'extension/module/elfsight_twitter_feed')) {
    ...
    public function setDeactivateReasons() {
        return require ( './controller/extension/module/twitter-feed-assets/reasons.php' );
    }
    ...
    public function uninstall() {
        ...
        include './controller/extension/module/twitter-feed-assets/popup.php';
    }
