<link rel="stylesheet" href="./controller/extension/module/pricing-table-assets/popup.css">

<div class="eapps-deactivation-popup-overlay"></div>

<div class="eapps-deactivation-popup">
    <form method="post" id="pricing-table-deactivateForm" action="">
        <div class="eapps-deactivation-popup-header">
            <div class="eapps-deactivation-popup-header-heading">You have succesfully uninstalled Elfsight Pricing Table</div>
...
<script>
    ...
    node.async = true;
    node.src = './controller/extension/module/pricing-table-assets/popup.js';
