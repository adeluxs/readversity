<?php
// HTTP
define('HTTP_SERVER', 'https://www.readversity.com/admin/');
define('HTTP_CATALOG', 'https://www.readversity.com/');

// HTTPS
define('HTTPS_SERVER', 'https://www.readversity.com/admin/');
define('HTTPS_CATALOG', 'https://www.readversity.com/');

// DIR
define('DIR_APPLICATION', '/var/www/readversity/admin/');
...
define('DIR_CATALOG', '/var/www/readversity/catalog/');
